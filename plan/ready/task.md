...
- [ ] **Replace `.vs/ ` with `.vscode/` on line 17 of `.gitignore`**
...
- [ ] **Confirm the `# Visual Studio cache/options directory` section and its `.vs/` entry are unchanged**
  - File: `/workspace/repo/.gitignore`

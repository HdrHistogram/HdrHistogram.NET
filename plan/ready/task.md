...
- [ ] **Task 1** — Create `CONTRIBUTING.md` at the repository root with a `# Contributing` heading and a one-to-two sentence introduction welcoming contributions.
...
- [ ] **Task 2** — Add `## Prerequisites` section to `CONTRIBUTING.md`.
...
- [ ] **Task 3** — Add `## Building` section to `CONTRIBUTING.md`.
  - **File**: `CONTRIBUTING.md`
...
- [ ] **Task 4** — Add `## Testing` section to `CONTRIBUTING.md`.
  - **File**: `CONTRIBUTING.md`
...
- [ ] **Task 5** — Add `## Code Style` section to `CONTRIBUTING.md`.
  - **File**: `CONTRIBUTING.md`
...
- [ ] **Task 6** — Add `## Git Workflow` section to `CONTRIBUTING.md`.
  - **File**: `CONTRIBUTING.md`
...
- [ ] **Task 7** — Add `## Pull Request Guidelines` section to `CONTRIBUTING.md`, migrating the prose from `README.md` lines 259–262.
  - **File**: `CONTRIBUTING.md`
...
- [ ] **Task 8** — Add `## Line Endings` section to `CONTRIBUTING.md`.
  - **File**: `CONTRIBUTING.md`
...
- [ ] **Task 9** — Add `## Cross-Platform Notes` section to `CONTRIBUTING.md`.
  - **File**: `CONTRIBUTING.md`
...
- [ ] **Task 10** — Replace the body of `README.md` `### How would I contribute to this project?` (lines 259–262) with a single sentence linking to `CONTRIBUTING.md`.
  - **File**: `README.md`
...
- [ ] **Task 11** — Add a one-line pointer to `CONTRIBUTING.md` in `README.md` `## Development` section (line 264 area).
  - **File**: `README.md`
...
- [ ] **Task 12** — Verify markdown formatting throughout `CONTRIBUTING.md` against `CLAUDE.md` standards.
  - **File**: `CONTRIBUTING.md`
...
- [ ] **Task 13** — Verify `README.md` diff is minimal and does not introduce formatting regressions.
  - **File**: `README.md`
